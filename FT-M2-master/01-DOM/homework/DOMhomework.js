...
document.querySelector('#createdBy').innerHTML += ' Thayrov';
...
//  3) Setear el valor del input toDoInput como un string vacío ("") (Esto se realiza para que en la vista se borre lo que se encontraba escrito)
