...
describe('Parte 2 | Character Routes', () => {
  ...
  describe('POST /character', () => {
    ...
    test('Si recibe todos los parámetros necesarios, debe responder con un estado 201 y el personaje creado', async () => {
      const res = await request(server)
        .post('/character')
        .send({code: 'NACHO', name: 'Ignacio', hp: 100.0, mana: 120.0, age: 20, race: 'Other'});
  ...
  describe('GET /character', () => {
    ...
    test('Debe responder con un estado 200 y la lista de los personajes', async () => {
      ...
      expect(res.body).toEqual([
        {code: 'ONE', name: 'First', hp: 90.0, mana: 150.0, age: 27, race: 'Human', RoleId: 2},
        {code: 'TWO', name: 'Second', hp: 135.0, mana: 40.0, age: 20, race: 'Machine', RoleId: 3},
        {code: 'THREE', name: 'Third', hp: 110.0, mana: 110.0, age: 23, race: 'Human', RoleId: 5},
      ]);
    });
